...
export const POSSESSIVE_IDS = [
  "pos-mein", "pos-dein", "pos-sein", "pos-unser", "pos-euer", "pos-ihr", "pos-kein",
] as const;
...
export function buildMorphMap(activeWordId: string | null): Map<string, MorphEntry> {
...
export function selectionRevealsPossessiveRow(activeWordId: string | null): boolean {
  return !!activeWordId && EIN_IDS.has(activeWordId);
}
